...
<script>
	...
	var goUrlForm = "/v1/infra/code/codeXdmForm";					/* #-> */
	var goUrlMultiUele = "/v1/infra/code/codeXdmMultiUele";			/* #-> */
	var goUrlMultiDele = "/v1/infra/code/codeXdmMultiDele";			/* #-> */
	
	var excelUri = "v1/infra/code/excelDownload";				/* #-> */
