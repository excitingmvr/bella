	...
	<c:otherwise>
		<c:forEach items="${list}" var="list" varStatus="status">	
            <tr>
                ...
                <td>
	                <c:choose>
	                	<c:when test="${list.xifcdSeqCount ne 0 }"><a href="/v1/infra/code/codeXdmList?ifcgSeq=<c:out value="${list.ifcgSeq }"/>"><c:out value="${list.xifcdSeqCount }"/></a></c:when>
...
<script>
	...
	var goUrlForm = "/v1/infra/codegroup/codeGroupXdmForm";					/* #-> */
	var goUrlMultiUele = "/v1/infra/codegroup/codeGroupXdmMultiUele";		/* #-> */
	var goUrlMultiDele = "/v1/infra/codegroup/codeGroupXdmMultiDele";		/* #-> */
	
	var excelUri = "/v1/infra/codegroup/excelDownload";					/* #-> */
