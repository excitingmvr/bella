...
<script>
	...
	var goUrlList = "/v1/infra/nationality/nationalityXdmList";					/* #-> */
	var goUrlForm = "/v1/infra/nationality/nationalityXdmForm";					/* #-> */
	var goUrlMultiUele = "/v1/infra/nationality/nationalityXdmMultiUele";			/* #-> */
	var goUrlMultiDele = "/v1/infra/nationality/nationalityXdmMultiDele";			/* #-> */
	
	var excelUri = "/v1/infra/nationality/excelDownload";					/* #-> */
