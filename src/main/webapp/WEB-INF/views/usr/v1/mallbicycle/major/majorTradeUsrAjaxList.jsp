                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 my-2">
                            <ol class="breadcrumb dark-link m-0 small justify-content-center justify-content-lg-end">
                                ...
                                <li class="breadcrumb-item text-nowrap" aria-current="page">거래</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
	...
	var goUrlLita = urlCommon + "majorTradeUsrLita";						/* #-> */
	var goUrlForm = urlCommon + "majorTradeUsrForm";						/* #-> */
	var goUrlView = urlCommon + "majorTradeUsrView";						/* #-> */
	var goUrlMultiUele = urlCommon + "majorTradeUsrMultiUele";				/* #-> */
	var goUrlMultiDele = urlCommon + "majorTradeUsrMultiDele";				/* #-> */
