                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 my-2">
                            <ol class="breadcrumb dark-link m-0 small justify-content-center justify-content-lg-end">
                                <li class="breadcrumb-item"><a class="text-nowrap" href="#"><i class="bi bi-home"></i>Road</a></li>
                                <li class="breadcrumb-item text-nowrap active" aria-current="page">Bicycle</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<script>
	...
	var goUrlAjaxList = urlCommon + "majorShowUsrAjaxList";		/* #-> */
	var goUrlInst = urlCommon + "majorShowUsrInst"; 			/* #-> */
	var goUrlUpdt = urlCommon + "majorShowUsrUpdt";			/* #-> */
	var goUrlUele = urlCommon + "majorShowUsrUele";			/* #-> */
