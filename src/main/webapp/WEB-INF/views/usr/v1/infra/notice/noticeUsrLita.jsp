...
<c:choose>
	<c:when test="${fn:length(list) eq 0}">
		<tr>
			<td class="text-center" colspan="3">There are no data!</td>
		</tr>	
	</c:when>
	<c:otherwise>
		<c:forEach items="${list}" var="list" varStatus="status">	
			...
			<tr>
				...
				<td class="p-3 td-title-edited"><a href="javascript:goView(<c:out value="${list.ifntSeq}"/>)" class="text-decoration-none"><c:out value="${list.ifntTitle }"/></a></td>
