...
<!-- includeUsrLeft s -->
<%@include file="../../include/includeUsrLeftCustomer.jsp"%>
<!-- includeUsrLeft e -->    
...
<!-- 
 ...
 -->	
	<h3><c:out value="${item.ifntTitle }"/></h3>
	<span class="small"><fmt:formatDate value="${item.modDateTime }" pattern="yyyy-MM-dd HH:mm:ss"/></span>
	<hr>
	<p><c:out value="${fn:replace(item.ifntContents, br, '<br/>')}" escapeXml = "false"/></p>
</article>
<div class="col-12">
...
<script type="text/javascript">
	...
	var urlCommon = "/v1/infra/notice/";
	
	var goUrlAjaxList = urlCommon + "noticeUsrAjaxList";				/* #-> */
	var goUrlLita = urlCommon + "noticeUsrLita";						/* #-> */
	var goUrlForm = urlCommon + "noticeUsrForm";						/* #-> */
	var goUrlView = urlCommon + "noticeUsrView";						/* #-> */
	var goUrlMultiUele = urlCommon + "noticeUsrMultiUele";				/* #-> */
	var goUrlMultiDele = urlCommon + "noticeUsrMultiDele";				/* #-> */
	
	var excelUri = urlCommon + "excelDownload";								/* #-> */
	
	var seq = $("input:hidden[name=inftSeq]");								/* #-> */
