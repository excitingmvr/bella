			...
			<div class="row">
				<div class="col-sm-6 mb-3">
					<div class="form-group">
						<label for="xPasswordOld" class="form-label">Old password</label>
						<input type="password" id="xPasswordOld" class="form-control" name="xPasswordOld">
					</div>
				</div>
				<div class="col-sm-6 mb-3">
				</div>				
				<div class="col-sm-6 mb-3">
					<div class="form-group">
						<label for="xPasswordNew" class="form-label">New password</label>
						<input type="password" id="xPasswordNew" class="form-control" name="xPasswordNew">
					</div>
				</div>
				<div class="col-sm-6 mb-3">
					<div class="form-group">
