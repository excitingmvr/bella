...
<!-- Left Menu -->
		<div class="shop-sidebar-block">
			<div class="shop-sidebar-title">
				<a class="h5" data-bs-toggle="collapse" href="#shop_categories" role="button" aria-expanded="true" aria-controls="shop_categories">My Page <i class="bi bi-chevron-up"></i></a>
			</div>
...
<!-- 					
 ...
 -->					
					<li class="nav-item">
						<a href="javascript:void(0);" class="nav-link" style="color: inherit; cursor: default;">즐겨찾기</a>
						<a data-bs-toggle="collapse" href="#leftMypageFavorite" role="button" aria-expanded="true" aria-controls="leftMypageFavorite" class="s-icon"></a>
						<div class="collapse show" id="leftMypageFavorite">
							<ul class="nav nav-pills flex-column nav-hierarchy">
								<li class="nav-item nav-item-edited">
									<a href="/v1/mallbicycle/major/majorFavoriteUsrAjaxList">자전거</a>&nbsp;&nbsp;|&nbsp;  
									<a href="/v1/mallbicycle/major/partFavoriteUsrAjaxList">부품</a>&nbsp;&nbsp;|&nbsp;
									<a href="/v1/mallbicycle/major/clothesFavoriteUsrAjaxList">의류</a>&nbsp;&nbsp;|&nbsp;
									<a href="/v1/mallbicycle/major/suppliesFavoriteUsrAjaxList">용품</a>
								</li>	
							</ul>
						</div>
					</li>
					<li class="nav-item">
						<a href="javascript:void(0);" class="nav-link" style="color: inherit; cursor: default;">거래</a>
						<a data-bs-toggle="collapse" href="#leftMypageTrade" role="button" aria-expanded="true" aria-controls="leftMypageTrade" class="s-icon"></a>
						<div class="collapse show" id="leftMypageTrade">
							<ul class="nav nav-pills flex-column nav-hierarchy">
								<li class="nav-item nav-item-edited">
									<a href="/v1/mallbicycle/major/majorTradeUsrAjaxList">자전거</a>&nbsp;&nbsp;|&nbsp;  
									<a href="/v1/mallbicycle/major/partTradeUsrAjaxList">부품</a>&nbsp;&nbsp;|&nbsp;
									<a href="/v1/mallbicycle/major/clothesTradeUsrAjaxList">의류</a>&nbsp;&nbsp;|&nbsp;
									<a href="/v1/mallbicycle/major/suppliesTradeUsrAjaxList">용품</a>
								</li>	
							</ul>
						</div>
					</li>					
					<li class="nav-item">
						<a href="javascript:void(0);" class="nav-link" style="color: inherit; cursor: default;">상품</a>
						<a data-bs-toggle="collapse" href="#leftMypageGoods" role="button" aria-expanded="true" aria-controls="leftMypageGoods" class="s-icon"></a>
						<div class="collapse show" id="leftMypageGoods">
							<ul class="nav nav-pills flex-column nav-hierarchy">
								<li class="nav-item nav-item-edited">
									<a href="/v1/mallbicycle/major/majorGoodsUsrAjaxList">자전거</a>&nbsp;&nbsp;|&nbsp;  
									<a href="/v1/mallbicycle/major/partGoodsUsrAjaxList">부품</a>&nbsp;&nbsp;|&nbsp;
									<a href="/v1/mallbicycle/major/clothesGoodsUsrAjaxList">의류</a>&nbsp;&nbsp;|&nbsp;
									<a href="/v1/mallbicycle/major/suppliesGoodsUsrAjaxList">용품</a>
								</li>								
							</ul>
						</div>
					</li>
					<li class="nav-item">
						<a href="javascript:void(0);" class="nav-link" style="color: inherit; cursor: default;">활동</a>
						<a data-bs-toggle="collapse" href="#leftMypageActivity" role="button" aria-expanded="true" aria-controls="leftMypageActivity" class="s-icon"></a>
						<div class="collapse show" id="leftMypageActivity">
							<ul class="nav nav-pills flex-column nav-hierarchy">
								<li class="nav-item">
					...
					<li class="nav-item">
						<a href="javascript:void(0);" class="nav-link" style="color: inherit; cursor: default;">개인정보</a>
						<a data-bs-toggle="collapse" href="#leftMypagePersonalInfo" role="button" aria-expanded="true" aria-controls="leftMypagePersonalInfo" class="s-icon"></a>
						<div class="collapse show" id="leftMypagePersonalInfo">
							<ul class="nav nav-pills flex-column nav-hierarchy">
								<li class="nav-item">
									<a href="/v1/infra/member/profileUsrForm" class="nav-link ">개인정보</a>
								</li>
								<li class="nav-item">
									<a href="/v1/infra/member/changePwdUsrForm" class="nav-link ">비밀번호변경</a>
								</li>
								<li class="nav-item">
									<a href="/v1/infra/member/withdrawalUsrForm" class="nav-link ">회원탈퇴</a>
								</li>
							</ul>
						</div>
					</li>					
