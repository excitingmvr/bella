...
public class Nationality extends Base implements Serializable{
	
	private static final long serialVersionUID = 1429090191189202604L;
	...
	public Integer getIfnaOrder() {
		return ifnaOrder;
	}
	public void setIfnaOrder(Integer ifnaOrder) {
